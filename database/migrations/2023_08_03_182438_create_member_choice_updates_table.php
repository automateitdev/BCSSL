...
class CreateMemberChoiceUpdatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('member_choice_updates', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('member_choice_updates');
    }
}
