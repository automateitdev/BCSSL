    ...
    <div id="enrollment_auto">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h3 class="mb-25">
                        <a href="{{ route('admin.payment.complete.list') }}">{{ get_page_meta('title', true) }}</a>
    ...
    @push('script')
        ...
        <script>
            ...
            let table = $('#myTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.completed.payment.list') }}",
                    headers: {
                    ...
                    data: function(d) {
                        ...
                        d.date_from = $('#startDate')
                            .val(); // Replace with the actual ID or selector of your date_from input
                        d.date_to = $('#endDate')
                            .val(); // Replace with the actual ID or selector of your date_to input
                    }
                },
                columns: [{
                        data: 'member.associators_info.membershp_number',
                        name: 'member.associators_info.membershp_number'
                    },
...

                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            if (data) {
                                return data.split('T')[0]; // Get the date part
                            }
                            return '';
                        }
                    },
                ...
                drawCallback: function() {
                    // Execute EZView code every time the DataTable is redrawn
                    $('img').EZView();
                }
            });
