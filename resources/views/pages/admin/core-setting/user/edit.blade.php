                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form data-parsley-validate action="{{route('admin.users.update',$user->id)}}" method="POST" enctype="multipart/form-data" id="form" >
                                @csrf
                                @method('PUT')
                                <div class="row">
                                <div class="col-md-8">
                                ...
                                <div class="col-md-4">
                                    ...
                                    />
                                    <img
                                        src="{{ !is_null($user->image) ? get_storage_image(\App\Models\User::ADMIN_IMAGE,$user->image) : asset('assets/images/dummy_pp_image.jpg')}}"
                                        alt=""
                                        class="img-fluid"
