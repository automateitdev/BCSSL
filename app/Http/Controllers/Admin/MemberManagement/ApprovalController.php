            ...
            if($request->sms == "yes")
            {
                ...
                if ($smsbank->sms_quantity < $memberCounter) {
                    ...
                    // foreach ($request->id as $key => $member_id) {
                        ...
                        $contentType = "unicode";
                        $message = "Dear $member->name, we are pleased to inform you that your membership has been $member->status. Your Member ID is $ass->membershp_number. Welcome to Cadre Officers Co-Operative Society Limited!";
